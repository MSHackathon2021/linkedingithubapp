...
const featuresInitialState: IOrgFeature[] = [
    {
        ...
        description: "Share a LinkedIn Company Post every time a new developer is sponsored by the Organization. The sponsee can be tagged in the post highlighting the sponsee's work.",
        isChecked: false,
    ...
    },
    {
        ...
        description: "Share a LinkedIn Company Post every time a new repository is created in the Organization.",
        isChecked: false,
        sourceImgUrl: "./GithubIcon.png",
        targetImageUrl: "./LinkedIn.png",
        showLinkedInPostTemplate: true
    },
    {
        ...
        description: "Share a LinkedIn Company Post every time there is a new release for any repository in the Organization. The release notes can also be added along with tagging the contributors.",
        isChecked: false,
        sourceImgUrl: "./GithubIcon.png",
        targetImageUrl: "./LinkedIn.png",
        showLinkedInPostTemplate: true
    ...
    {
        title: "Share New Package added to an organization in LinkedIn Company Post",
        description: "Share a LinkedIn Company Post every time a new package is added or updated in the Organization.",
        isChecked: false,
        sourceImgUrl: "./GithubIcon.png",
        targetImageUrl: "./LinkedIn.png",
        showLinkedInPostTemplate: true
